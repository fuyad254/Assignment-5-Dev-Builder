  ...
  return (
    <>
      <div className='flex justify-between container m-auto mt-20 items-center'>
        <div className=''>
        <h2 className='text-slate-900 text-[60px] font-extrabold mb-10 leading-none'>Build Your Ideal<br /><span className='bg-linear-to-r from-[#FF5722] via-[#D81B7E] to-[#7C3AED] bg-clip-text text-transparent '>Development Stack</span></h2>
        ...
        <div className='flex gap-6'>
          <button className='bg-linear-to-r from-[#FF5722] via-[#D81B7E] to-[#7C3AED] px-3 py-2 rounded-md cursor-pointer text-white font-semibold'>Explore Technologies</button>
